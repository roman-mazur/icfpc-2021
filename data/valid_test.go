...
func TestScaleToPreserveRatio(t *testing.T) {
	for _, tcase := range []struct{
		...
		{
			name: "equal",
			n: &Edge{A: &Vertex{X: 1, Y: 1}, B: &Vertex{X: 1, Y: 3}},
			o: &Edge{A: &Vertex{X: 2, Y: 2}, B: &Vertex{X: 2, Y: 4}},
			eps: 1,
		},
		{
			name: "too big",
			n: &Edge{A: &Vertex{X: 2, Y: 2}, B: &Vertex{X: 2, Y: 6}},
			o: &Edge{A: &Vertex{X: 1, Y: 1}, B: &Vertex{X: 1, Y: 3}},
			eps: 2e5,
		},
		{
			name: "too small",
			n: &Edge{A: &Vertex{X: 1, Y: 1}, B: &Vertex{X: 1, Y: 3}},
			o: &Edge{A: &Vertex{X: 2, Y: 2}, B: &Vertex{X: 2, Y: 6}},
			eps: 5e5,
		},
	} {
